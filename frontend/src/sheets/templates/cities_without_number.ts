  ...
  sections: [
    ...
    },
    {
      ...
      fields: [
        ...
        { id: 'strain_mod', label: 'LIFESTYLE', type: 'number', placeholder: '0', hint: "Added to your maximum System Strain, which is otherwise your CON score. Negative numbers are fine, and a GM can use it for anything the table agrees.\n\nLIFESTYLE (CWN p51), the only thing the book changes it for:\n  Squatter, abandoned building   -2\n  Slum, shared apartment         -1\n  Middle-class rental             0\n  Fine, clean and secure         +1\n  Luxury                         +2\n\nDo not enter cyberware here. A Full Body Conversion and a Cybernetic Infrastructure Baseline already change what you can carry and the augmentation window counts them for you, so adding them again would pay twice." },
    ...
    },
    {
      ...
      fields: [
        ...
        { id: 'armor_trauma_mod', label: 'TT MOD', type: 'number', placeholder: '0', hint: "Your armor's Trauma Target Mod, as the book prints it. Added to the base 6.\n\n  Clothing, war harness, street leathers        0\n  Longcoats, armored clothing, impact jacket   +1\n  Light or medium armored suit                 +2\n  Heavy armored suit                           +3\n\nOnly the armor belongs here. Cyberware raises Trauma Target too, and the augmentation window applies that separately." },
