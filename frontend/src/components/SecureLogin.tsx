    ...
    <div className="modal-overlay">
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <div className="panel login-panel" style={{ textAlign: 'center', minWidth: '350px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          {/* Below the THEMES and sound buttons rather than level with them: they sit in the
              panel's top corners, and a centered line on the same row runs into THEMES as
              the version number grows. */}
          <div data-testid="login-version" style={{ fontSize: '0.75rem', fontWeight: 700, color: 'var(--green)', textShadow: 'var(--glow)', letterSpacing: '4px', marginBottom: '15px', marginTop: '28px' }}>NAV_OS_v{__APP_VERSION__}</div>
