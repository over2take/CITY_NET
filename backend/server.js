...
function runSanityChecks() {
  ...
  // sqlite3 serializes all ops on one connection — a BEGIN on the live db
  // would pull real request writes into the transaction and roll them back.
  ...
  testDb.serialize(() => {
    // Minimal schema — only what the 8 tests actually need
